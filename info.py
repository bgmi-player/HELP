...
PICS = (environ.get('PICS', 'https://telegra.ph/file/58fef5cb458d5b29b0186.jpg')).split() #SAMPLE PIC
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://kushal-kumar-013-346fcdbbfbc3.herokuapp.com/")
